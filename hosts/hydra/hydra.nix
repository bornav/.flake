...
# in
{
  ...
  services.hydra = {
    ...
    extraConfig = lib.mkMerge [
      ...
      #   oidc_token_uri = "https://sso.icylair.com/oauth2/token"                    # kanidm oauth2 token endpoint
      #   oidc_userinfo_uri = "https://sso.icylair.com/oauth2/openid/hydra/userinfo" # kanidm userinfo endpoint, client id must match
      #   oidc_client_secret = <>                      # should contain `oidc_client_secret = <secret>`
      ...
      #   <oidc_role_mapping>
      #     hydra.admins@sso.icylair.com = admin
      #     hydra.admins@sso.icylair.com = bump-to-front
      #     hydra.users@sso.icylair.com = cancel-build
      #     hydra.users@sso.icylair.com = eval-jobset
      #     hydra.users@sso.icylair.com = create-projects
      #     hydra.users@sso.icylair.com = restart-jobs
      #   </oidc_role_mapping>
      # ''
    ];
  };
