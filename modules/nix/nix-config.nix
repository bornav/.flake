  ...
  config = {
      nix = {
        ...
        settings = {
          ...
          warn-dirty = false;
          allow-import-from-derivation = false; # don't allow IFD, they're slow asf # TODO lookinto
          ...
          extra-substituters = [
            ...
            "http://binarycache.icylair.com"
          ];
          extra-trusted-public-keys = [
            "binarycache.icylair.com-1:+obxym992HRK8NeFVXpJ2OdmKE7nIDeCXI6XejDoCoM="
